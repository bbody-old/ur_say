...
class OptionsControllerTest < ActionController::TestCase
  ...
  test "should create option" do
    assert_difference('Option.count') do
      post :create, option: { poll_id: @option.poll_id, poll_id: @option.poll_id, title: @option.title }
    end
  ...
  test "should update option" do
    patch :update, id: @option, option: { poll_id: @option.poll_id, poll_id: @option.poll_id, title: @option.title }
    assert_redirected_to option_path(assigns(:option))
  end
